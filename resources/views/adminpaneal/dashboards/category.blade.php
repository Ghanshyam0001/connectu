          ...
          <div class="card mb-4">
            <div class="card-header">
              <div class="d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0">Category Types</h3>
  ...
  <div class="modal fade" id="addtype" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <form id="addtyp">
          <div class="modal-body">
            <div id="error-message" class="error-message text-danger px-2 py-1 mb-2" style="display:none;"></div>
